...
public class MarkdownExtractorGUI extends JFrame {
    ...
    public MarkdownExtractorGUI() {
        ...
        tabbedPane.addTab("get image & .md", tab1.createFirstTab());

        // 其他頁簽可稍後加入
        // tabbedPane.addTab("第二頁", createSecondTab());
        ...
        processButton.addActionListener(e -> {
            ...
            if (selectedIndex == 0) {
                tab1.processMarkdown();  // 如果當前是 tab1，則執行 tab1 的 processMarkdown()
            } else {
                JOptionPane.showMessageDialog(this, "當前不在第一頁，無法執行該操作");
            }
        });
